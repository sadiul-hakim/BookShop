<nav class="navbar navbar-expand-lg bg-primary navbar-dark navbar">
    <div class="container">
        <a class="navbar-brand" href="index.jsp"> <img src="img/icon/logo.png"
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown me-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#"><i class="fa fa-id-badge"></i> Profile</a></li>
                ...
                <li class="nav-item"><a
                        ...
                        aria-current="page" href="login.jspx"><i
